            ...
            <table class="admin-table">
                ...
                <tbody>
                    @forelse($bookings as $booking)
                        <tr>
                            ...
                            <td>
                                <div style="font-size: 0.9rem;">
                                    @if($booking->start_date)
                                        <strong>Start:</strong> {{ $booking->start_date->format('M d, Y') }}<br>
                                    @else
                                        <strong>Start:</strong> <span style="color: rgba(250, 235, 215, 0.4);">Not set</span><br>
                                    @endif
                                    
                                    @if($booking->end_date)
                                        <strong>End:</strong> {{ $booking->end_date->format('M d, Y') }}
                                    @else
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="{{ route('admin.bookings.edit', $booking) }}" class="btn-admin-secondary btn-sm">
                        ...
                        <!-- ID Card Modal -->
                        @if($booking->user && $booking->user->id_card)
