...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Kost Facilities Management <?php $__env->endSlot(); ?>
     <?php $__env->slot('header', null, []); ?> Kost Facilities Management <?php $__env->endSlot(); ?>
    ...
    <div class="admin-card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('admin.kostfac.create')); ?>" class="btn-admin-primary">
                        ...
                        <tr>
                            ...
                            <td data-label="Actions">
                                <div class="d-flex gap-2">
                                    <a href="<?php echo e(route('admin.kostfac.edit', $facility)); ?>" class="btn-admin-secondary">
                                        <i class="bi bi-pencil"></i> Edit
                                    </a>
                                    <form action="<?php echo e(route('admin.kostfac.destroy', $facility)); ?>" method="POST" onsubmit="return confirm('Are you sure?');" class="d-inline">
                                        <?php echo csrf_field(); ?>
