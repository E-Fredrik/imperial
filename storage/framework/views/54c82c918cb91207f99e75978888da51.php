...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Edit Information <?php $__env->endSlot(); ?>
     <?php $__env->slot('header', null, []); ?> Edit Information <?php $__env->endSlot(); ?>
     <?php $__env->slot('icon', null, []); ?> bi-info-circle <?php $__env->endSlot(); ?>

    <div class="admin-card" style="max-width: 900px; margin: 0 auto;">
        <div class="card-header">
            <h3><i class="bi bi-info-circle me-2"></i>Edit Information</h3>
        ...
        <form action="<?php echo e(route('admin.info.update', $information)); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="title" 
                    id="title" 
                    value="<?php echo e(old('title', $information->title)); ?>"
                    required
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.trix-input','data' => ['id' => 'content','name' => 'content','value' => old('content', $information->content ?? ''),'autocomplete' => 'off']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'content','name' => 'content','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('content', $information->content ?? '')),'autocomplete' => 'off']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Uni\WebDev\Laravel\imperial\resources\views/admin/info/edit.blade.php ENDPATH**/ ?>